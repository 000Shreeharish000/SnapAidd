...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#09090b] flex flex-col" data-testid="register-page">
      {/* Header */}
          ...
          <div className="glass rounded-2xl p-8 space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label className="text-zinc-300">{t('selectRole')}</Label>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-10 bg-black/50 border-zinc-700 text-white placeholder:text-zinc-500"
                    required
